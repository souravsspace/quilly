    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 flex flex-col items-center justify-center text-center sm:mt-40">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-xl">
          Quilly allows you to have conversations with any PDF document. Simply
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 text-4xl font-bold text-gray-900 sm:text-5xl">
              Start a conversation in minutes.
            </h2>
            <p className="te mt-4 text-lg text-gray-400">
              Quilly allows you to have conversations with any PDF document.
